...
namespace PasswordManagementApp.Services;
...
public static class EmbeddedIcons
{
    public static EmbeddedDatabase iconZipFile = new EmbeddedDatabase(Path.Combine(PxDataFile.TmpFilePath, "icons.zip"),
        "icons", "PasswordManagementApp.data.icons.zip");

    public static EmbeddedDatabase[] IconFiles = new EmbeddedDatabase[]
    {
            new EmbeddedDatabase(Path.Combine(PxDataFile.IconFilePath, "ic_passxyz_cloud.png"), "ic_passxyz_cloud", "PasswordManagementApp.data.ic_passxyz_cloud.png"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.IconFilePath, "ic_passxyz_local.png"), "ic_passxyz_local", "PasswordManagementApp.data.ic_passxyz_local.png"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.IconFilePath, "ic_passxyz_disabled.png"), "ic_passxyz_disabled", "PasswordManagementApp.data.ic_passxyz_disabled.png"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.IconFilePath, "ic_passxyz_sync.png"), "ic_passxyz_sync", "PasswordManagementApp.data.ic_passxyz_sync.png"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.IconFilePath, "ic_passxyz_synced.png"), "ic_passxyz_synced", "PasswordManagementApp.data.ic_passxyz_synced.png")
    };
}
...
public static class TEST_DB
{
    ...
    {
            new EmbeddedDatabase(Path.Combine(PxDataFile.DataFilePath, "pass_d_E8f4pEk.xyz"), "12345", "PasswordManagementApp.data.pass_d_E8f4pEk.xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.DataFilePath, "pass_e_JyHzpRxcopt.xyz"), "123123", "PasswordManagementApp.data.pass_e_JyHzpRxcopt.xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.KeyFilePath, "pass_k_JyHzpRxcopt.k4xyz"), "", "PasswordManagementApp.data.pass_k_JyHzpRxcopt.k4xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.DataFilePath, "pass_e_2TjEf1Dy9V2jiEgbS.xyz"), "123123", "PasswordManagementApp.data.pass_e_2TjEf1Dy9V2jiEgbS.xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.KeyFilePath, "pass_k_2TjEf1Dy9V2jiEgbS.k4xyz"), "", "PasswordManagementApp.data.pass_k_2TjEf1Dy9V2jiEgbS.k4xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.DataFilePath, "pass_e_VpdPx4ZcUZs8Fpzpmuu.xyz"), "123123", "PasswordManagementApp.data.pass_e_VpdPx4ZcUZs8Fpzpmuu.xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.KeyFilePath, "pass_k_VpdPx4ZcUZs8Fpzpmuu.k4xyz"), "", "PasswordManagementApp.data.pass_k_VpdPx4ZcUZs8Fpzpmuu.k4xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.DataFilePath, "pass_e_WCXaKYYvXygN3nVYW3u.xyz"), "123123", "PasswordManagementApp.data.pass_e_WCXaKYYvXygN3nVYW3u.xyz"),
            new EmbeddedDatabase(Path.Combine(PxDataFile.KeyFilePath, "pass_k_WCXaKYYvXygN3nVYW3u.k4xyz"), "", "PasswordManagementApp.data.pass_k_WCXaKYYvXygN3nVYW3u.k4xyz"),
    };
}
